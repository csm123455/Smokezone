...
public final class ActivityMessageBinding implements ViewBinding {
  ...
  private ActivityMessageBinding(@NonNull ConstraintLayout rootView,
      @NonNull RecyclerView chatListRecyclerView, @NonNull LinearLayout toolbarLayout) {
    this.rootView = rootView;
    this.chatListRecyclerView = chatListRecyclerView;
  ...
  public static ActivityMessageBinding bind(@NonNull View rootView) {
    ...
    int id;
    missingId: {
      id = R.id.chatListRecyclerView;
      RecyclerView chatListRecyclerView = ViewBindings.findChildViewById(rootView, id);
      ...
      return new ActivityMessageBinding((ConstraintLayout) rootView, chatListRecyclerView,
          toolbarLayout);
    }
