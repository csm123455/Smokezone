...
public final class ItemChatBinding implements ViewBinding {
  ...
  private ItemChatBinding(@NonNull ConstraintLayout rootView, @NonNull TextView messageTextView,
  ...
  public static ItemChatBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ItemChatBinding((ConstraintLayout) rootView, messageTextView, senderTextView);
    }
